...
random_number = Math.floor(Math.random() * array_1);
sketch_tobedrawn = array_1[random_number];
document.getElementById("sketch_to_be_drawn").innerHTML = "sketch to be drawn:" + sketch_tobedrawn;
...
function draw() {
    check_sketch();
    if(drawn_sketch==sketch_tobedrawn){
        answer_holder="set"
        score=score+1
